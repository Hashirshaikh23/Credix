...
const AuthForm = ({type}: {type: string}) => {
  ...
  const onSubmit = async (data: z.infer<typeof formSchema>) => {
    ...
    try {
      // Sign up with Appwrite & Plaidlink token
    ...
    <section className='auth-form'>
        ...
        <Link href="/" className='cursor-pointer flex items-center gap-1 '>
            <Image
              ...
              alt='Credix Logo'
            />
              <h1 className='text-26 font-ibm-plex-serif font-bold text-black-1'>Credix</h1>
          </Link>
                  ...
                  {type === 'sign-up' && (
                    <>
                      <div className='flex gap-4'>
                        ...
                        />
                        <CustomInput
                          control={form.control} name='lastName' label='Last Name' placeholder='Enter your password'
                        />
                      </div>
                      ...
                      <div className='flex gap-4'>
                        <CustomInput
                          control={form.control} name='state' label='State' placeholder='Example: MH'
                        />
                        <CustomInput
                          control={form.control} name='postalCode' label='Postal Code' placeholder='Example: 11011'
                        />
                      </div>
                      <div className='flex gap-4'>
                        <CustomInput
                          control={form.control} name='dataOfBirth' label='Date of Birth' placeholder='YYYY-MM-DD'
                        />
                        <CustomInput
